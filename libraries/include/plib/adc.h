...
#define ENABLE_AN0_DIG()              ANCON0bits.ANSEL0=1 /*Enable AN0 in digital mode */
#define ENABLE_AN0_ANA()              ANCON0bits.ANSEL0=0 /*Enable AN0 in analog mode */
#define ENABLE_AN1_DIG()              ANCON0bits.ANSEL1=1 /*Enable AN1 in digital mode */
#define ENABLE_AN1_ANA()              ANCON0bits.ANSEL1=0 /*Enable AN1 in analog mode */
#define ENABLE_AN2_DIG()              ANCON0bits.ANSEL2=1 /*Enable AN2 in digital mode */
#define ENABLE_AN2_ANA()              ANCON0bits.ANSEL2=0 /*Enable AN2 in analog mode */
#define ENABLE_AN3_DIG()              ANCON0bits.ANSEL3=1 /*Enable AN3 in digital mode */
#define ENABLE_AN3_ANA()              ANCON0bits.ANSEL3=0 /*Enable AN3 in analog mode */
#define ENABLE_AN4_DIG()              ANCON0bits.ANSEL4=1 /*Enable AN4 in digital mode */
#define ENABLE_AN4_ANA()              ANCON0bits.ANSEL4=0 /*Enable AN4 in analog mode */
#if defined (ADC_V13) || defined (ADC_V13_1)  || defined (ADC_V13_3)
#define ENABLE_AN5_DIG()              ANCON0bits.ANSEL5=1 /*Enable AN5 in digital mode */
#define ENABLE_AN5_ANA()              ANCON0bits.ANSEL5=0 /*Enable AN5 in analog mode */
#define ENABLE_AN6_DIG()              ANCON0bits.ANSEL6=1 /*Enable AN6 in digital mode */
#define ENABLE_AN6_ANA()              ANCON0bits.ANSEL6=0 /*Enable AN6 in analog mode */
#define ENABLE_AN7_DIG()              ANCON0bits.ANSEL7=1 /*Enable AN7 in digital mode */
#define ENABLE_AN7_ANA()              ANCON0bits.ANSEL7=0 /*Enable AN7 in analog mode */
