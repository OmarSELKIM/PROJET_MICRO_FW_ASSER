...
#if defined(_10F204) || defined(_10F206)
volatile	bit	CWU	@ (unsigned)&CMCON*8+0;
volatile	bit	CPREF	@ (unsigned)&CMCON*8+1;
volatile	bit	CNREF	@ (unsigned)&CMCON*8+2;
volatile	bit	CMPON	@ (unsigned)&CMCON*8+3;
volatile	bit	CMPT0CS	@ (unsigned)&CMCON*8+4;
volatile	bit	POL	@ (unsigned)&CMCON*8+5;
volatile	bit	COUTEN	@ (unsigned)&CMCON*8+6;
