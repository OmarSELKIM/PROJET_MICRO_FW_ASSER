...
volatile	unsigned char	     	PMDATA	@ 0x18C;
volatile	unsigned char	     	PMDATH	@ 0x18D;
volatile	unsigned char	     	PMADR	@ 0x18E;
volatile	unsigned char	      	PMADRH	@ 0x18F;
...
volatile	bit		ADRESH3	@ (unsigned)&ADRESH*8+4;
...
volatile	bit		ADRESL3	@ (unsigned)&ADRESL*8+4;
...
/*	PMDATA bits	*/
volatile	bit	PMDATA7	@ (unsigned)&PMDATA*8+7;
volatile	bit	PMDATA6	@ (unsigned)&PMDATA*8+6;
volatile	bit	PMDATA5	@ (unsigned)&PMDATA*8+5;
volatile	bit	PMDATA4	@ (unsigned)&PMDATA*8+4;
volatile	bit	PMDATA3	@ (unsigned)&PMDATA*8+3;
volatile	bit	PMDATA2	@ (unsigned)&PMDATA*8+2;
volatile	bit	PMDATA1	@ (unsigned)&PMDATA*8+1;
volatile	bit	PMDATA0	@ (unsigned)&PMDATA*8+0;

/*	PMADR bits	*/
volatile	bit	PMADR7	@ (unsigned)&PMADR*8+7;
volatile	bit	PMADR6	@ (unsigned)&PMADR*8+6;
volatile	bit	PMADR5	@ (unsigned)&PMADR*8+5;
volatile	bit	PMADR4	@ (unsigned)&PMADR*8+4;
volatile	bit	PMADR3	@ (unsigned)&PMADR*8+3;
volatile	bit	PMADR2	@ (unsigned)&PMADR*8+2;
volatile	bit	PMADR1	@ (unsigned)&PMADR*8+1;
volatile	bit	PMADR0	@ (unsigned)&PMADR*8+0;
...
/*	PMADRH bits	*/
volatile	bit	PMADRH4	@ (unsigned)&PMADRH*8+4;
