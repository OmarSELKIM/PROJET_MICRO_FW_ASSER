...
volatile char __DCByte;    // Data capture word for MPLAB to monitor
volatile char _DCDelay;   // Transmit delay value for MPLAB to init
...
/*********************************************************************
* __DCDelay to be initialized by REAL ICE based upon target speed
**********************************************************************/
